            ...
            <fieldset>
                <div className="pure-g">
                    ...
                    <div className="pure-u-1 pure-u-md-1-3">
                        ...
                        <input id="customIsbn" className="pure-u-23-24" type="text" value={customIsbn} onChange={changeCustomIsbn}/>
                    </div>
                    ...
                    <div className="pure-u-1 pure-u-md-1-3">
                        ...
                        <input id="category" className="pure-u-23-24" type="text" value={category} onChange={changeCategory}/>
                    </div>
                    ...
                    <div className="pure-u-1 pure-u-md-1-3">
                        ...
                        <input id="description" className="pure-u-23-24" type="text" value={description} onChange={changeDescription}/>
                    </div>

                    <div className="pure-u-1 pure-u-md-1-3">
                        <label htmlFor="imageUrl">Image Url</label>
                        <input id="imageUrl" className="pure-u-23-24" type="text" value={imageUrl} onChange={changeImageUrl}/>
                    </div>
